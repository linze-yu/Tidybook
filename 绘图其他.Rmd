...
```{r, 代码全局设置, echo = F}
knitr::opts_chunk$set(warning = F, error = F, message = F, prompt = F, comment = "", echo = T, dpi = 115, collapse = F, fig.align = "left", dev = "png", cache = T)
# , eval = F代码显示不运行
...
import("D:/desktop/book/tidybook/data/other/网络图.xlsx") %>%
  ...
  geom_edge_arc(aes(edge_alpha = Cor, edge_width = Cor), color = "#34558B") + # 画线
